...
#define rRTCCON    __REG(RTC_BASE)       //RTC control
#define rTICINT    __REG(RTC_BASE+0x4)   //Tick time count
#define rRTCALM    __REG(RTC_BASE+0x10)  //RTC alarm control
#define rALMSEC    __REG(RTC_BASE+0x14)  //Alarm second
#define rALMMIN    __REG(RTC_BASE+0x18)  //Alarm minute
#define rALMHOUR   __REG(RTC_BASE+0x1c)  //Alarm Hour
#define rALMDATE   __REG(RTC_BASE+0x20)  //Alarm day      <-- May 06, 2002 SOP
#define rALMMON    __REG(RTC_BASE+0x24)  //Alarm month
#define rALMYEAR   __REG(RTC_BASE+0x28)  //Alarm year
#define rRTCRST    __REG(RTC_BASE+0x2c)  //RTC round reset
#define rBCDSEC    __REG(RTC_BASE+0x30)  //BCD second
#define rBCDMIN    __REG(RTC_BASE+0x34)  //BCD minute
#define rBCDHOUR   __REG(RTC_BASE+0x38)  //BCD hour
#define rBCDDATE   __REG(RTC_BASE+0x3c)  //BCD day        <-- May 06, 2002 SOP
#define rBCDDAY    __REG(RTC_BASE+0x40)  //BCD date       <-- May 06, 2002 SOP
#define rBCDMON    __REG(RTC_BASE+0x44)  //BCD month
#define rBCDYEAR   __REG(RTC_BASE+0x48)  //BCD year
